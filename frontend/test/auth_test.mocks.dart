...
// in storystains/test/auth_test.dart.
// Do not manually edit this file.

import 'dart:async' as _i3;

import 'package:mockito/mockito.dart' as _i1;
import 'package:storystains/modules/auth/auth_service.dart' as _i2;
...
class MockAuthService extends _i1.Mock implements _i2.AuthService {
  ...
  _i3.Future<dynamic> login(String? username, String? password) =>
      (super.noSuchMethod(Invocation.method(#login, [username, password]),
          returnValue: Future<dynamic>.value()) as _i3.Future<dynamic>);
  @override
  _i3.Future<dynamic> user(int? id) =>
      (super.noSuchMethod(Invocation.method(#user, [id]),
          returnValue: Future<dynamic>.value()) as _i3.Future<dynamic>);
}
